...
def update_training_data(days):
    ...
    max_date = calc_date(max_date, -days)  # Latest date of complete data (assuming ending price is collected at 9:00am)
...
def main(date, prediction_range, pool=None):
    ...
    hist_data = update_training_data(prediction_range)  # update in case any past days are missing
